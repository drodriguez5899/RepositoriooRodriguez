...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-06-2021 a las 00:30:31
...
('DoctrineMigrations\\Version20210603152422', '2021-06-03 17:24:33', 2310);
...
CREATE TABLE `favorito` (
  ...
  `fest_otro_id` int(11) DEFAULT NULL
...
INSERT INTO `favorito` (`id`, `usuario_id`, `fest_destacado_id`, `fest_otro_id`) VALUES
(17, 20, 11, NULL),
(29, 20, 23, NULL),
(31, 20, 26, NULL),
(33, 47, 14, NULL),
...
(9, 'Medusa Festival', 'yo recomiendo  si te gusta la música electrónica el medusa es tu festival', '60492023ea530.jpg', 2, '2021-03-29 15:37:53'),
(13, 'arenal', 'bastante guay', '604d2e476ab83.jpg', 9, '2021-03-29 15:37:53'),
(22, 'yghhhhhhh', 'hgggggggggg', '60bfbe2975509.jpg', 20, '2021-06-08 18:59:53'),
(24, 'eeeeeeeeeee', 'eeeeeeeeeeee', '60c2923987a54.jpg', 49, '2021-06-10 22:29:13');
...
(20, 'david.rodriguez5899@gmail.com', '[]', '$argon2id$v=19$m=65536,t=4,p=1$WENyMHk1ek80YjRJb2NBYQ$kcoE1f/kN2wB85fr3vGN5Web87wbDznkOeormVc3SBo', 'david', 'rodriguez', 878787, 'ES', 'Masculino', '60b4fa9300570.jpg', '$argon2id$v=19$m=65536,t=4,p=1$bkwyb1BNcE5LQzFtRFJBZA$cyoBWiq1zbtpFw7F2reYc4dnXpuc44KRJmD00OSNB0M'),
...
(46, 'jaime@sasaasas', '[]', '$argon2id$v=19$m=65536,t=4,p=1$NENUVGlGbjVwdDcuV2pZUg$vkMwr3lLfdR4aWRpEAbw0WywDHqg43/xjpo8noQ2b38', 'jaime', 'contrras', 6967677, 'GN', 'Masculino', '60c234eb50fdd.jpg', '$argon2id$v=19$m=65536,t=4,p=1$ZUl3Z29wc1MzSERWYkN6SQ$GwS0/9JY5Ab0xdNQQ2kfPxEi7CX4adGVCtQqpmcFrLI'),
(47, 'ddedeede@asasa', '[]', '$argon2id$v=19$m=65536,t=4,p=1$WmJGWkc5c3ZpZEJTc0pMaw$blsKonR2EKfmoQxqaoiY/dlyC/oGr3W4mxdWT4ht3NE', 'bv', 'vbv', 6565, 'AF', 'Masculino', '60c27d783b5e1.jpg', '$argon2id$v=19$m=65536,t=4,p=1$YTAybDZhMERlL1NhYXo0VA$KML8Ldfrcc95CVYkLaG6AdxpKdbZORI+TD274HYtuMc'),
(48, 'josejuan@dsds', '[]', '$argon2id$v=19$m=65536,t=4,p=1$cXNBaWs4Sm8ua1MuWGhPQw$6pUeKNDC/2IgwUHxpVVptIWlv8ezmW3+Vzkc/LLFRzc', 'ffdfd', 'rodriguez', 6350, 'BY', 'Masculino', '60c28505143a5.jpg', '$argon2id$v=19$m=65536,t=4,p=1$UGw0dXV2cU5YZzh0cE9Vcw$VB/Y45hdsIZ8w6vjtCEZibikouVHghrP/u36IlTq6i4'),
(49, 'elena@asa', '[]', '$argon2id$v=19$m=65536,t=4,p=1$RlA4L3c3NHplQ0Q1YzJTNA$Z2Gw3VvH945a+2yYcOVnDyBMNSErL79R5XgDYTACTCk', 'elenhi', 'sss', 646757, 'BB', 'Femenino', '60c2921684bfd.jpg', '$argon2id$v=19$m=65536,t=4,p=1$NUVnOWxjZDloQmJDdWNabA$WccPZtRdar/adl0eujonn+kJuXerW2YCCz0BUYZ+4mU');
...
ALTER TABLE `favorito`
  ...
  ADD KEY `IDX_881067C7351443D6` (`fest_otro_id`);
...
--
ALTER TABLE `favorito`
  ADD CONSTRAINT `FK_881067C7351443D6` FOREIGN KEY (`fest_otro_id`) REFERENCES `festival_otro` (`id`),
